        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-soft-gray max-w-3xl mx-auto">
              Our residents are building the future across diverse fields - from AI and biotech to web3 and beyond.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className="bg-background p-8 rounded-2xl shadow-soft hover:shadow-elegant transition-all duration-300"
              >
                <div className="mb-6">
                  ...
                  <h4 className="text-lg font-medium text-charcoal">{testimonial.name}</h4>
                  <p className="text-soft-gray text-sm">{testimonial.role}</p>
                  <p className="text-accent text-sm font-medium mt-1">{testimonial.project}</p>
                </div>
