...
export default function VerticalEventTimelineCarousel() {
  ...
  const handleDragEnd = (
    ...
    if (info.offset.y > SWIPE_THRESHOLD && index === currentIndex) {
      prevSlide();
    } else if (info.offset.y < -SWIPE_THRESHOLD && index === currentIndex) {
      nextSlide();
    }
  };
  ...
  return (
    <div className="mx-auto px-4 py-12 max-w-7xl">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-primary/20 z-0"></div>
          ...
          <div className="flex h-full items-center justify-center">
            {events.map((item, index) => (
              <motion.div
                ...
                style={{
                  y: `${Math.round((index - currentIndex) * 300)}px`,
